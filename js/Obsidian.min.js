...
jQuery(function($){
    $(".slider").click(function() { //The Left Side bar's Hide/Show button function
        ...
        if((window.location.href.indexOf("index.php") != -1 && window.location.href.indexOf("index.php?") == -1 && $('div.bloc h4').length != false) || $('input[name=ulogin]').length != false) {
            $("head").append('<link rel="stylesheet" href="themes/gtarosastheme/css/login.css">');
        ...
        $('img').each(function() {
            if ($(this).attr('src') == 'images/edit.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/edit.png');
            }else if ($(this).attr('src') == 'images/file_size.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/file_size.png');
            }else if ($(this).attr('src') == 'images/ftp.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/ftp.png');
            }else if ($(this).attr('src') == 'images/install.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/install.png');
            }else if ($(this).attr('src') == 'images/txt.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/txt.png');
            }else if ($(this).attr('src') == 'images/log.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/log.png');
            }else if ($(this).attr('src') == 'images/rsync.png') {
                $(this).attr('src', 'themes/Ogtarosastheme/images/rsync.png');
            }else if ($(this).attr('src') == 'images/magnifglass.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/magnifglass.png');
            }else if ($(this).attr('src') == 'images/icon_help_small.gif') {
                $(this).attr('src', 'themes/gtarosastheme/images/icon_help_small.png');
            }else if ($(this).attr('src') == 'images/steam.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/steam.png');
            }else if ($(this).attr('src') == 'images/auto_update.png') {
                $(this).attr('src', 'themes/gtarosastheme/images/auto_update.png');
            }
        });
    ...
    $(this).find('[class$="_nextPageLink"]').addClass('g_nPL');
        ...
        if(window.location.href.indexOf("home.php?m=") > -1) {
            ...
            $.ajax({
            url: "themes/gtarosastheme/upload/get.php",
            type: 'get',
            dataType: 'html',
            async: false,
            success: function(data) {
            $(".menu .avatar-cover").prepend('<img id="avatar" src="themes/gtarosastheme/' + data + '">');
            }
                    });
        }	//href index of end.
        ...
        $('body').on('click', '#remove_avatar',function(){
            $.ajax({
             url: "themes/gtarosastheme/upload/remove.php",
       type: "POST",
       data:  {remove: "1"},
       success: function(data)
          {
              $("#avatar").remove();
            $(".menu .avatar-cover").prepend('<img id="avatar" src="themes/gtarosastheme/images/default_avatar.png">');
          },
          error: function(data)
          {
          }
        ...
        $(".avatarinput").change((function(){
            $("#avatar").remove();
         $(".avatar-cover").prepend('<img id="avatar" src="themes/gtarosastheme/images/spinner_big.gif">');
         var form = $('#ava-form').get(0); 
      $.ajax({
             url: "themes/gtarosastheme/upload/upload.php",
       type: "POST",
       ...
       success: function(data)
         ...
         error: function() 
          {
              $("#avatar").remove();
              $(".avatar-cover").prepend('<img id="avatar" src="themes/gtarosastheme/images/error.png">').fadeIn();
          }          
        });
        }));	//body.on.change end.
